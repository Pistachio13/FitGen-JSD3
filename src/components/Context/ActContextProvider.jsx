...
export default function ActivitesContextProvider({ children }) {
    ...
    const createActivity = (e, activity) => {
        ...
        fetch(`https://fitgen-backend-fsxwpyquj-krit357.vercel.app/activities/create`, requestOptions)
            .then((res) => res.json())
    ...
    const deleteActivity = async (_id) => {
        try {
          const response = await fetch(`https://fitgen-backend-fsxwpyquj-krit357.vercel.app/activities/${_id}/delete`, {
            method: 'DELETE',
          });
    ...
    const fetchActivities = async () => {
        try {
            const result = await fetch(`https://fitgen-backend-fsxwpyquj-krit357.vercel.app/activities`)
    ...
    const onUpdateActivity = (e) => {
        e.preventDefault()
        fetch(`https://fitgen-backend-fsxwpyquj-krit357.vercel.app/activities/${editActivity._id}/update`, {
            method: 'PUT',
